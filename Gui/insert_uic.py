...
class Ui_Insert(object):
    def setupUi(self, Insert):
        ...
        self.range_num_min.setPlaceholderText("请输入密码最小长度(非必填)")
        self.verticalLayout_2.addWidget(self.range_num_min)
        ...
        self.range_num_max.setPlaceholderText("请输入密码最大长度(非必填)")
        self.verticalLayout_2.addWidget(self.range_num_max)

        self.must_str = QLineEdit(self.in_frame)
        self.must_str.setObjectName(u"must_str")
        self.must_str.setMinimumSize(QSize(300, 40))
        self.must_str.setMaximumSize(QSize(300, 40))
        self.must_str.setFont(font1)
        self.must_str.setStyleSheet(u"")
